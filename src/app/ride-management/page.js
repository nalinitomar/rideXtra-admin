              ...
              <table className="min-w-full divide-y divide-gray-200 text-sm text-center">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-gray-600 font-medium">UserPhone</th>
                ...
                <tbody className="divide-y divide-gray-100 text-gray-700">
                  {users.map((data, index) => (
                    <tr key={data._id}>
                      ...
                      <td className="px-4 py-3">{`${data?.userId?.name ?? "Guest"}`}</td>
                      <td className="px-4 py-3">{`+${data?.userId?.phone ? data?.userId?.phone :917754869907}`}</td>
                      <td className="px-4 py-3">{`${data?.driverId?.name ?? "Guest"}`}</td>
                      <td className="px-4 py-3">{`+${data?.driverId?.phone ?data?.driverId?.phone :91748799083}`}</td>
                      <td className="px-4 py-3">
                        <span
                      ...
                      <td className="px-4 py-3">{data?.payment?.method}</td>
                      <td className="px-4 py-3">{data?.fareDetails?.totalFare}</td>
                      <td className="px-4 py-3">{`${data?.rideType}`}</td>
                      <td className="px-4 py-3">{data?.bookingType}</td>
